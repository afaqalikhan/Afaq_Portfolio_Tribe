...
export const ProjectsSection = () => {
  return (
  <section className="pb-16 lg:py-24" id = "explore my work">
        ...
        {portfolioProjects.map( (project , projectIndex) => (
          ...
          <Card key={project.title} className="px-8 pt-8 pb-0 md:pt-12 md:px-10 lg:pt-16 lg:px-20 sticky" style ={{ top : `calc(64px + ${projectIndex * 40}px)` }}>
            <div className="grid lg:grid-cols-2 lg:gap-16">
              <div className="grid'col lg:pb-16">
                <div className="bg-gradient-to-r from-emerald-300 to-sky-300 inline-flex gap-2 font-bold  uppercase tracking-widest text-sm text-transparent bg-clip-text">
                  ...
                  <Image src={project.image} alt={project.title} className="mt-8 -mb-4 md:-mb-4 lg:mt-0 lg:absolute lg:h-full lg:w-auto lg:max-w-none" />
                  </div>
            </div>
          </Card>
